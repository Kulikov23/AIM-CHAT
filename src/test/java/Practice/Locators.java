...
public interface Locators {
    ...
    String PUBLIC_RADIOBUTTON = "//input[@value='public']";
    String SUBBMIT = "//button[@type='submit']";
    String ADD_ROOM = "//h4[contains(text(),'Add Room')]";
    String CHANNELS = "//li[@class='b-room room-public grey']/a";
    String FIRST_CHANNEL = "(//li[@class='b-room room-public grey']/a)[1]";
